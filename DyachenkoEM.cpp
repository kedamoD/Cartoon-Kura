...
void MoveKyraVedetCip_1()
    ...
    for (int t = 0; t <= 200; t += 2)
        ...
        PaintCipa ( 10  + 2*t, 600,  0.8,       1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 *(-5),  1, 0);
        PaintCipa (-100 + 2*t, 580,  0.8,       1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 *(-5),  1, 0);
        PaintCipa (-70  + 2*t, 600,  0.8,       1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 *(-5),  1, 0);
        PaintCipa (-180 + 2*t, 600,  0.8,       1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 *(-5),  1, 0);
        PaintCipa (-140 + 2*t, 580,  0.8,       1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 *(-5),  1, 0);
...
void FellAppl_4()
    ...
    for (int t = 0; t <= 200; t += 10)
        ...
        PaintCipa (645, 635, 0.8, 1,    0, 0,  1, 0);
        PaintCipa (600, 610, 0.8, 1,    0, 0,  1, 0);
        PaintCipa (334, 600, 0.8, 1,    0, 0, -1, 0);
        PaintCipa (145, 635, 0.8, 1,    0, 0,  1, 0);
        PaintCipa (485, 680, 0.8, 1,    0, 0,  1, 0);
...
void VhodGysen_5()
    ...
    for (int t = 0; t <= 200; t += 2)
        ...
        PaintCipa (570, 550, 0.8,   2, 0, 0,  1,  10);
        PaintCipa (255, 635, 0.8,   2, 0, 0,  1,   0);
        PaintCipa (600, 650, 0.8, 1.5, 0, 0,  1,  10);
        PaintCipa (334, 600, 0.8, 1.5, 0, 0,  1,   0);
        PaintCipa (385, 720, 0.8, 1.5, 0, 0,  1,  10);
        PaintCipa (450, 705, 0.8,   2, 0, 0,  1,   0);
...
void PobegGysen_6()
    ...
    for (int t = 0; t <= 600; t += 2)
        ...
        PaintKura (440 + 2*t, 520, 1.2, 0, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 * (-5),  -1,        0, t%2 * 15);
        PaintCipa (570 + 2*t, 550, 0.8, 1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 * (-5),   1, t%2 * 10);
        PaintCipa (255 + 2*t, 635, 0.8, 1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 * (-5),   1,        0);
        PaintCipa (600 + 2*t, 650, 0.8, 1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 * (-5),   1,        0);
        PaintCipa (334 + 2*t, 600, 0.8, 1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 * (-5),   1, t%2 * 10);
        PaintCipa (385 + 2*t, 720, 0.8, 1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 * (-5),   1,        0);
        PaintCipa (450 + 2*t, 705, 0.8, 1, ((t/10) % 2 * 2 - 1) * 5, (t/10) % 2 * (-5),   1, t%2 * 10);
...
void StartTitles()
    ...
    while (t <= 85)
        ...
        PaintCipa (1690 - t*10, 370, 1.5, 1, ((t/10) % 2 *2 - 1) *5, (t/10) % 2 *(-5), -1, 0);
